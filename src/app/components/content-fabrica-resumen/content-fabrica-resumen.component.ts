...
export class ContentFabricaResumenComponent implements OnInit {
  ...
  cargarFormularioResumen() {
    this.formaResumen.reset({
      ...
      Servicio_Gestión_Crédito_Documental_sinIva: this.resumenes.ValorSinIva,
      Iva_servicios: this.resumenes.Iva,
      //Servicio_Gestión_Crédito: this.resumenes.ValorPorGestionCredito,
      //Servicio_Gestión_Documental: this.resumenes.ValorServicioDocumental,
      Valor_Total_Factura: this.resumenes.VENTA_TOTAL_CRE,
      Monto_Crédito: this.resumenes.VALOR_DESEM_CRE,
      Plazo: this.resumenes.PLAZO_DEUDA_CRE,
      Cuota_Mensual_Estimada: this.resumenes.CUOTA_FIJA_SOL,
      Cuota_Mensual_Pagaré: this.resumenes.CUOTA_MENSUAL_REAL,
  ...
  crearFormularioResumen() {
    this.formaResumen = this.fb.group({
      ...
      //Servicio_Gestión_Crédito: [''],
      //Servicio_Gestión_Documental: [''],
      Servicio_Gestión_Crédito_Documental_sinIva: [''],
      Iva_servicios: [''],
      Valor_Total_Factura: [''],
      Monto_Crédito: [''],
      Plazo: [''],
      Cuota_Mensual_Estimada: [''],
      Cuota_Mensual_Pagaré: [''],
